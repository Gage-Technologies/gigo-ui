...
import {initialAuthStateUpdate, selectAuthState, TutorialState, updateAuthState} from "../../reducers/auth/auth";
        ...
        <>
            <HelmetProvider>
                <Helmet>
                    ...
                    {authState.authenticated && authState.id != "" && authState.role === 1 && (
