...
import journey from "./journey-quiz-trunk.svg";
import journey219 from "./journey-quiz-trunk-21-9.svg";
import React from "react";

function JourneyQuizTrunkIcon(props: any) {
...
export default JourneyQuizTrunkIcon;
