...
import journey from "./journey-page.svg";
import journey219 from "./journey-page-21-9.svg";
import React from "react";

function JourneyPageIcon(props: any) {
    ...
    if (props.aspectRatio === '21:9') {
        ...
        return (
            <div style={{...props.style, width: props.width, paddingBottom, position: 'relative'}}>
                <img alt="" src={journey} style={{position: 'absolute', width: '100%', height: '100%'}} />
            </div>
        );
    }
...
export default JourneyPageIcon;
