import world from "./real-world.svg";
import React from "react";
import learn from "./learn.svg";

function AboutPageWorldIcon(props: any) {
    ...
    if (props.aspectRatio === '21:9') {
        return (
            <div style={{...props.style, width: props.width, paddingBottom, position: 'relative'}}>
                <img alt="" src={world} style={{position: 'absolute', width: '100%', height: '100%', bottom: '10%'}} />
            </div>
        );
...
export default AboutPageWorldIcon;